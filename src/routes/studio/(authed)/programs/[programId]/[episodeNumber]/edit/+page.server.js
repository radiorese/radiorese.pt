...
export async function load({ params, locals }) {
  ...
  export const actions = {
    ...
    editEpisode: async ({ request }) => {
        ...
        try {
            await db.query('UPDATE episode SET title = $1, synopsis = $2, filelink = $3, streaminglink = $4, isavailablelocally = $5, duration = $6 WHERE program_id = $7 AND number = $8', [title, synopsis, fileLink, streamingLink, isAvailableLocally, duration, programId, number]);
