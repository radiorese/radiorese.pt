...
<div class="popup solidBorder bRadius1">
	<form class="tSize1" method="POST" action="?/addMember">
		...
		<label>
			...
			<input
				name="name"
				type="text"
				class="tSize1 bRadius1 solidBorder"
				required
				placeholder="Rafa Silva Arias"
			/>
		</label>
		<label>
		...
		<label>
			...
			<input
				...
				class="tSize1 bRadius1 solidBorder"
				required
				placeholder="arias.rafael@outlook.pt"
			/>
		</label>
		<label>
			...
			<input
				...
				class="tSize1 bRadius1 solidBorder"
				required
				placeholder="934472501"
			/>
		</label>
		<div class="mTop-xl">
			<button type="button" class="bRadius1 solidBorder" on:click={cancel}>Cancelar</button>
			<button id="submit" type="submit" class="bRadius1">Criar Membro</button>
		</div>
	</form>
</div>
